...
Network1 = struct('pnts',[PointA PointB PointC PointD],'boun',[],'area',0,'loca',[0 0],'velo',[1,-1],'avel',0,'mass',0,'mofi',0,'forc',[0 0],'name', 'Network 1');
Network2 = struct('pnts',[PointE PointF PointG PointH],'boun',[],'area',0,'loca',[0 0],'velo',[-0.5,0],'avel',0,'mass',0,'mofi',0,'forc',[0 0], 'name', 'Network 2');
